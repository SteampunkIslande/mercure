...
A cette fin, il existe trois dossiers, chacun remplissant une fonction dans le déploiement continu des pipelines, sans que l'exécution de la production ne risque d'être impactée.
